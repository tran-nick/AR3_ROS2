...
def generate_launch_description():
    ...
    rviz_base2 = os.path.join(get_package_share_directory("ar3_move_group"),"launch")
    ...
    rviz_move_group_config = os.path.join(rviz_base, "move_group.rviz")
    rviz_node_tutorial = Node(
        package="rviz2",
        executable="rviz2",
        name="rviz2",
        output="log",
        arguments=["-d", rviz_move_group_config],
        parameters=[
            robot_description,
            robot_description_semantic,
            ompl_planning_pipeline_config,
